  ...
  return (
    <div className="py-12 text-white">
      <ul className=" w-full  grid grid-cols-1  md:flex  ">
        ...
        <li className=" md:flex bg-cover bg-center    hidden bg-no-repeat h-72 items-start p-4 flex-col justify-end   w-full  bg-[url('https://www.blippo.com/cdn/shop/files/footer-ghibli_eeefb044-9718-49b4-8934-055a8a82679c_720x.jpg?v=1688525089')]">
          <button className="bg-ThemeMainPink rounded-3xl px-4 py-2">
            Shop Sanrio
          </button>
        </li>
